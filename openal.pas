...
uses
  Classes
  , SysUtils
  {$IF Defined(Win32) or Defined(Win64)},Windows{$ENDIF}
  ;
...
{$IFDEF Win32}
Const callibname='OpenAL32.dll';
Const  calutlibname='Alut.dll';
{$ENDIF}
...
{$IFDEF Linux}
Const  callibname='libopenal.so';
Const  calutlibname='libalut.so';
{$ENDIF}
