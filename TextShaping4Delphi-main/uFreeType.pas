...
// {$MESSAGE FATAL 'Replace every instance of "constref" in this file by "Constref", then disable this error.'}
{$ENDIF}
...
{$else ifdef LINUX}
   FreeTypeDLL = 'libfreetype.so.6.20.1';
{$endif}
...
Type
   ...
   TFTOutlineFuncs = Record
      MoveTo: Function(constref ATo: TFTVector; Const AUser: Pointer): Integer; Cdecl;
      LineTo: Function(constref ATo: TFTVector; Const AUser: Pointer): Integer; Cdecl;
      ConicTo: Function(constref AControl, ATo: TFTVector; Const AUser: Pointer): Integer; Cdecl;
      CubicTo: Function(constref AControl1, AControl2, ATo: TFTVector; Const AUser: Pointer): Integer; Cdecl;
      Shift: Integer;
      Delta: TFTPos;
   End;
   ...
   Strict Private
{$HINTS OFF}
      FGraySpans, FBlackSpans: Procedure(Const AY, ACount: Integer; constref ASpans: TFTSpan; Const AUser: Pointer); Cdecl;
...
{$HINTS ON}
   ...
   Public
      ...
      RasterNew:     Function(constref AMemory: TFTMemory; Out ORaster: TFTRaster): Integer; Cdecl;
      ...
      RasterRender:  Function(Const ARaster: TFTRaster; constref AParams: TFTRasterParams): Integer; Cdecl;
...
{$ENDREGION}
   ...
   Strict Private
      ...
      Class Function MemAlloc(constref AMemory: TFTMemory; Const ASize: Integer): Pointer; Static; Cdecl;
      Class Procedure MemFree(constref AMemory: TFTMemory; Const ABlock: Pointer); Static; Cdecl;
      Class Function MemRealloc(constref AMemory: TFTMemory; Const ACurSize, ANewSize: Integer; Const ABlock: Pointer): Pointer; Static; Cdecl;
   ...
   Function FT_Library_SetLcdFilterWeights(&Library: TFTLibrary; constref AWeights: TFTLCDFiveTapFilter): TFTError; Cdecl; External FreeTypeDLL ;
   Function FT_Library_SetLcdGeometry(&Library: TFTLibrary; constref ASub: TFTLCDThreeVecs): TFTError; Cdecl; External FreeTypeDLL ;
   {$ENDREGION}
   {$REGION 'freetype.h'}
   ...
   Function FT_Open_Face(Const ALibrary: TFTLibrary; constref AArgs: TFTOpenArgs; Const FaceIndex: LongInt; Out OFace: TFTFace): TFTError; Cdecl; External FreeTypeDLL ;
   Function FT_Attach_File(Face: TFTFace; Const AFilePathName: PAnsiChar): TFTError; Cdecl; External FreeTypeDLL ;
   Function FT_Attach_Stream(Face: TFTFace; constref AParameters: TFTOpenArgs): TFTError; Cdecl; External FreeTypeDLL ;
   ...
   Function FT_Request_Size(Face: TFTFace; constref AReq: TFTSizeRequest): TFTError; Cdecl; External FreeTypeDLL ;
   ...
   Function FT_Get_Charmap_Index(constref ACharmap: TFTCharMap): Integer; Cdecl; External FreeTypeDLL ;
   ...
   Function FT_Get_SubGlyph_Info(constref AGlyph: TFTGlyphSlot; Const ASubIndex: Cardinal; Out OIndex: Integer; Out OFlags: TFTSubGlyphFlags; Out OArg1, OArg2: Integer; Out OTransform: TFTMatrix)
   ...
   Procedure FT_Vector_Transform(Var Vector: TFTVector; constref AMatrix: TFTMatrix); Cdecl; External FreeTypeDLL ;
   // FreeType Version
   ...
   Function FT_Bitmap_Copy(Const ALibrary: TFTLibrary; constref ASource: TFTBitmap; Var Target: TFTBitmap): TFTError; Cdecl; External FreeTypeDLL ;
   ...
   Function FT_Bitmap_Convert(Const ALibrary: TFTLibrary; constref ASource: TFTBitmap; Var Target: TFTBitmap; Const Alignment: Integer): TFTError; Cdecl; External FreeTypeDLL ;
   Function FT_Bitmap_Blend(Const ALibrary: TFTLibrary; constref ASource: TFTBitmap; Const ASourceOffset: TFTVector; Var Target: TFTBitmap; Var TargetOffset: TFTVector; Const AColor: TFTColor)
      : TFTError; Cdecl; External FreeTypeDLL ;
   ...
   {$ENDREGION}
   {$REGION 'ftmodapi.h'}
   Function FT_Add_Module(&Library: TFTLibrary; constref AClass: TFTModuleClass): TFTError; Cdecl; External FreeTypeDLL ;
   ...
   Function FT_New_Library(constref AMemory: TFTMemory; Out OLibrary: TFTLibrary): TFTError; Cdecl; External FreeTypeDLL ;
...
Class Function TFTManager.MemAlloc(constref AMemory: TFTMemory; Const ASize: Integer): Pointer;
Begin
   Result := GetMemory(ASize);
End;

Class Procedure TFTManager.MemFree(constref AMemory: TFTMemory; Const ABlock: Pointer);
Begin
   FreeMemory(ABlock);
End;

Class Function TFTManager.MemRealloc(constref AMemory: TFTMemory; Const ACurSize, ANewSize: Integer; Const ABlock: Pointer): Pointer;
Begin
